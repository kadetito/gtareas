...
//	posts_url: "http://jsonplaceholder.typicode.com/posts",
	posts_url: "http://www.webentorn.com/gtareas/backoffice/json/listamensajes.json.php?identi="+identificacion_empleado,
	get_url : "detallemensaje.html",
	...
	onSuccess: function(data) {
		...
		$.each(data, function(key, val){
			...
			items.push('<div class="row row-striped"><div class="col-2 text-center"><h3 class="displaydia">'+val.numerodia+'</h3><h4 class="nombremes">'+val.nombremes+'</h4></div><div class="col-10"><a class="enlacetarea" href="' + app.get_url +'?param='+ val.id_mensaje + '"><h3 class="text-uppercase"><strong>' +val.titulo + '</strong></h3><ul class="list-inline"><li class="list-inline-item"><i class="fa fa-calendar-o" aria-hidden="true"></i> '+val.nombredia+'</li><li class="list-inline-item"><i class="fa fa-clock-o" aria-hidden="true"></i> 12:30 PM - 2:00 PM</li><li class="list-inline-item"><i class="fas fa-chevron-circle-right"></i></li></ul><p>'+val.texto+'</p></a></div></div>');
			
			
			numitems.push(''+val.numeromens+'');
...
//			items.push('<div class="card"><div class="card-body"><a class="enlacetarea" href="' + app.get_url +'?param='+ val.id_tarea + '"><span class="fechas">' + val.fecha + '</span> - ' +val.codigo_tarea + ' <h5>' +val.titulo + '</h5><div class="icono_ir"><i class="fas fa-chevron-circle-right"></i></div></a></div></div>');
		...
		$('#numeromensajes').html(numitems.join(''));
