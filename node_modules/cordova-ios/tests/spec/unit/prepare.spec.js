...
describe('prepare', function () {
    ...
    describe('updateProject method', function () {
        ...
        it('<access> - should handle wildcard, with NSAllowsArbitraryLoadsInWebContent', function (done) {
            ...
            var configXml = '<?xml version="1.0" encoding="UTF-8"?><widget id="io.cordova.gtareascordova" ios-CFBundleIdentifier="io.cordova.gtareascordova.ios" version="0.0.1" xmlns="http://www.w3.org/ns/widgets" xmlns:cdv="http://cordova.apache.org/ns/1.0"><name>SampleApp</name>' +
